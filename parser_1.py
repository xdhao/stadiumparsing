...
OUT_XLSX_FILENAME = 'from_wildstat.xlsx'
...
for div_countries in countries:
    for a_countries in div_countries:
        ...
        leagues.append(soup1.find('div', class_='smn-left-w'))
        l_items = []
        ...
        for div_leagues in leagues:
            for a_leagues in div_leagues:
                ...
                if not 'Суперкубок' in league_name and 'Чемпионат' in league_name:
                    league_name = soup2.find('h1').text + soup2.find('h2').text
